...
class AdressCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(AdressCell.modifyImageViewClick(tap:)))
    ...
    class func adressCell(tableView: UITableView, indexPath: IndexPath, modifyClickCallBack:@escaping ((Int) -> Void)) -> AdressCell {
