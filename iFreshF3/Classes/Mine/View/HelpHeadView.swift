...
class HelpHeadView: UITableViewHeaderFooterView {
  ...
  var isSelected: Bool = false {
    ...
    override init(reuseIdentifier: String?) {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(HelpHeadView.headViewDidClick(tap:)))
...
//        isSelected = !isSelected
        if delegate != nil && delegate!.responds(to: #selector(HelpHeadViewDelegate.headViewDidClck(headView:))) {
